...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/domain/schema/
...
#### Example Request
	...
	curl -s --dump-header - \
		...
		https://admin.mailroute.net/api/vi/domain/schema/
...
#### Definition
	...
	POST https://admin.mailroute.net/api/vi/domain/
...
bounce_unlisted| |false|Boolean - is email list complete, bounce email to unlisted users?|
customer|*required*| |A single related resource. Can be either a URI or set of nested resource data|
...
outbound_enabled| |false|Boolean - is domain enabled for outbound mail (may incur an extra cost)|
policy| | |A single related resource. Can be either a URI or set of nested resource data|
...
#### Example Request
	...
	curl -s --dump-header - -X POST \
		...
		https://admin.mailroute.net/api/vi/domain/
...
#### Definition
	...
	PUT https://admin.mailroute.net/api/vi/domain/111/
...
#### Example Request
	...
	curl -s --dump-header - -X PUT \
		...
		https://admin.mailroute.net/api/vi/domain/111/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/domain/
...
#### Definition
	...
	DELETE https://admin.mailroute.net/api/vi/domain/111/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/domain_alias/schema/
...
#### Example Request
	...
	curl -s --dump-header - \
		-H 'Content-Type: application/json' \
		-H 'Authorization: ApiKey <login>:<apikey>' \
		https://admin.mailroute.net/api/vi/domain_alias/schema/
...
#### Definition
	...
	POST https://admin.mailroute.net/api/vi/domain_alias/
...
parameter | required | default | description
-----|-----|-----|-----|
name|*required*| |String - The name of the domainalias|
...
#### Example Request
	...
	curl -s --dump-header - -X POST \
		...
		https://admin.mailroute.net/api/vi/domain_alias/
...
#### Definition
	...
	PUT https://admin.mailroute.net/api/vi/domain_alias/198/
...
#### Example Request
	...
	curl -s --dump-header - -X PUT \
		...
		https://admin.mailroute.net/api/vi/domain_alias/198/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/domain_alias/
...
#### Definition
	...
	DELETE https://admin.mailroute.net/api/vi/domain_alias/198/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/mail_server/schema/
...
#### Example Request
	...
	curl -s --dump-header - \
		-H 'Content-Type: application/json' \
		-H 'Authorization: ApiKey <login>:<apikey>' \
		https://admin.mailroute.net/api/vi/mail_server/schema/
...
#### Definition
	...
	POST https://admin.mailroute.net/api/vi/mail_server/
...
parameter | required | default | description
-----|-----|-----|-----|
server|*required*| |String - mailserver FQDN or IP address|
domain|*required*| |String - domain_uri|
...
#### Example Request
	...
	curl -s --dump-header - -X POST \
		...
		https://admin.mailroute.net/api/vi/mail_server/
...
#### Definition
	...
	PUT https://admin.mailroute.net/api/vi/mail_server/86/
...
#### Example Request
	...
	curl -s --dump-header - -X PUT \
		...
		https://admin.mailroute.net/api/vi/mail_server/86/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/mail_server/
...
#### Definition
	...
	DELETE https://admin.mailroute.net/api/vi/mail_server/86/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/outbound_server/schema/
...
#### Example Request
	...
	curl -s --dump-header - \
		-H 'Content-Type: application/json' \
		-H 'Authorization: ApiKey <login>:<apikey>' \
		https://admin.mailroute.net/api/vi/outbound_server/schema/
...
#### Definition
	...
	POST https://admin.mailroute.net/api/vi/outbound_server/
...
parameter | required | default | description
-----|-----|-----|-----|
server|*required*| |String - mailserver IP Address|
domain|*required*| |String - domain_uri|
...
#### Example Request
	...
	curl -s --dump-header - -X POST \
		...
		https://admin.mailroute.net/api/vi/outbound_server/
...
#### Definition
	...
	PUT https://admin.mailroute.net/api/vi/outbound_server/81/
...
#### Example Request
	...
	curl -s --dump-header - -X PUT \
		...
		https://admin.mailroute.net/api/vi/outbound_server/81/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/outbound_server/
...
#### Definition
	...
	DELETE https://admin.mailroute.net/api/vi/outbound_server/81/
...
#### Definition
	...
	PUT https://admin.mailroute.net/api/vi/policy_domain/177/
...
#### Example Request
	...
	curl -s --dump-header - -X PUT \
		...
		https://admin.mailroute.net/api/vi/policy_domain/177/
...
### The Domain White and Blacklists Object
...
### Creating a Domain White and Blacklists
...
Deleting a Domain White and Blacklists

#### Definition

	DELETE https://admin.mailroute.net/api/vi/wblist/77/
...
#### Example Request
	...
	curl -s --dump-header - -X DELETE \
		-H 'Content-Type: application/json' \
		-H 'Authorization: ApiKey <login>:<apikey>' \
		https://admin.mailroute.net/api/vi/wblist/77/
...
#### Definition
	...
	PUT https://admin.mailroute.net/api/vi
...
#### Example Request
	...
	curl -s --dump-header - -X PUT \
		...
		https://admin.mailroute.net/api/vi
