...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/reseller/schema/
...
#### Example Request
	...
	curl -s --dump-header - \
		...
		https://admin.mailroute.net/api/vi/reseller/schema/
...
#### Definition
	...
	POST https://admin.mailroute.net/api/vi/reseller/
...
-----|-----|-----|-----|
name|*required*| |String - The name of the Reseller|
...
#### Example Request
	...
	curl -s --dump-header - -X POST \
		...
		https://admin.mailroute.net/api/vi/reseller/
...
#### Definition
	...
	PUT https://admin.mailroute.net/api/vi/reseller/371/
...
#### Example Request
	...
	curl -s --dump-header - -X PUT \
		...
		https://admin.mailroute.net/api/vi/reseller/371/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/reseller/
...
#### Definition
	...
	DELETE https://admin.mailroute.net/api/vi/reseller/371/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/contact_reseller/schema/
...
#### Example Request
	...
	curl -s --dump-header - \
		-H 'Content-Type: application/json' \
		-H 'Authorization: ApiKey <login>:<apikey>' \
		https://admin.mailroute.net/api/vi/contact_reseller/schema/
...
#### Definition
	...
	POST https://admin.mailroute.net/api/vi/contact_reseller/
...
#### Example Request
	...
	curl -s --dump-header - -X POST \
		...
		https://admin.mailroute.net/api/vi/contact_reseller/
...
#### Definition
	...
	PUT https://admin.mailroute.net/api/vi/contact_reseller/313/
...
#### Example Request
	...
	curl -s --dump-header - -X PUT \
		...
		https://admin.mailroute.net/api/vi/contact_reseller/313/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/reseller/371/contacts/
...
#### Example Request
	...
	curl -s --dump-header - \
		-H 'Content-Type: application/json' \
		-H 'Authorization: ApiKey <login>:<apikey>' \
		https://admin.mailroute.net/api/vi/reseller/371/contacts/
...
#### Definition
	...
	DELETE https://admin.mailroute.net/api/vi/contact_reseller/313/
...
#### Definition
	...
	POST https://admin.mailroute.net/api/vi/admins/reseller/371/
...
#### Example Request
	...
	curl -s --dump-header - -X POST \
		...
		https://admin.mailroute.net/api/vi/admins/reseller/371/
...
#### Definition
	...
	GET https://admin.mailroute.net/api/vi/admins/reseller/371/
...
#### Definition
	...
	DELETE https://admin.mailroute.net/api/vi/admins/reseller/371/admin/50/
...
#### Example Request
	...
	curl -s --dump-header - -X DELETE \
		-H 'Content-Type: application/json' \
		-H 'Authorization: ApiKey <login>:<apikey>' \
		https://admin.mailroute.net/api/vi/admins/reseller/371/admin/50/
